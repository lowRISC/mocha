...
module xbar_peri (
  ...
  assign tl_clkmgr_o = tl_s1n_12_ds_h2d[1];
  assign tl_s1n_12_ds_d2h[1] = tl_clkmgr_i;

  assign tl_rstmgr_o = tl_s1n_12_ds_h2d[2];
  assign tl_s1n_12_ds_d2h[2] = tl_rstmgr_i;

  assign tl_pwrmgr_o = tl_s1n_12_ds_h2d[3];
  assign tl_s1n_12_ds_d2h[3] = tl_pwrmgr_i;

  assign tl_asf_13_us_h2d = tl_s1n_12_ds_h2d[4];
  assign tl_s1n_12_ds_d2h[4] = tl_asf_13_us_d2h;

  assign tl_uart_o = tl_s1n_12_ds_h2d[5];
  assign tl_s1n_12_ds_d2h[5] = tl_uart_i;

  assign tl_i2c_o = tl_s1n_12_ds_h2d[6];
  assign tl_s1n_12_ds_d2h[6] = tl_i2c_i;

  assign tl_spi_device_o = tl_s1n_12_ds_h2d[7];
  assign tl_s1n_12_ds_d2h[7] = tl_spi_device_i;

  assign tl_timer_o = tl_s1n_12_ds_h2d[8];
  assign tl_s1n_12_ds_d2h[8] = tl_timer_i;

  assign tl_plic_o = tl_s1n_12_ds_h2d[9];
  assign tl_s1n_12_ds_d2h[9] = tl_plic_i;

  assign tl_asf_11_us_h2d = tl_axi_xbar_i;
  assign tl_axi_xbar_o = tl_asf_11_us_d2h;

  assign tl_s1n_12_us_h2d = tl_asf_11_ds_h2d;
  assign tl_asf_11_ds_d2h = tl_s1n_12_us_d2h;

  assign tl_rom_ctrl_regs_o = tl_asf_13_ds_h2d;
  assign tl_asf_13_ds_d2h = tl_rom_ctrl_regs_i;
