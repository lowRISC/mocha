...
// CVA6 - Tapping the XBAR Subordinate Port 0 (Manager VIP side)
assign axi4_mgr_if[top_pkg::CVA6].aclk    = clk;
assign axi4_mgr_if[top_pkg::CVA6].aresetn = rst_n;

always_comb begin
  // Request signals (Manager -> XBAR)
...
// RomCtrlMem - Tapping the XBAR Manager Port 0 (Subordinate VIP side)
assign axi4_sub_if[top_pkg::RomCtrlMem].aclk    = clk;
assign axi4_sub_if[top_pkg::RomCtrlMem].aresetn = rst_n;

always_comb begin
  // Request signals (XBAR -> Subordinate)
  axi4_sub_if[top_pkg::RomCtrlMem].awvalid  = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw_valid;
  axi4_sub_if[top_pkg::RomCtrlMem].awid     = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.id;
  axi4_sub_if[top_pkg::RomCtrlMem].awaddr   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.addr;
  axi4_sub_if[top_pkg::RomCtrlMem].awlen    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.len;
  axi4_sub_if[top_pkg::RomCtrlMem].awsize   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.size;
  axi4_sub_if[top_pkg::RomCtrlMem].awburst  = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.burst;
  axi4_sub_if[top_pkg::RomCtrlMem].awlock   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.lock;
  axi4_sub_if[top_pkg::RomCtrlMem].awcache  = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.cache;
  axi4_sub_if[top_pkg::RomCtrlMem].awprot   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.prot;
  axi4_sub_if[top_pkg::RomCtrlMem].awqos    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.qos;
  axi4_sub_if[top_pkg::RomCtrlMem].awregion = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.region;
  axi4_sub_if[top_pkg::RomCtrlMem].awuser   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].aw.user;

  axi4_sub_if[top_pkg::RomCtrlMem].wvalid   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].w_valid;
  axi4_sub_if[top_pkg::RomCtrlMem].wdata    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].w.data;
  axi4_sub_if[top_pkg::RomCtrlMem].wstrb    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].w.strb;
  axi4_sub_if[top_pkg::RomCtrlMem].wlast    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].w.last;
  axi4_sub_if[top_pkg::RomCtrlMem].wuser    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].w.user;

  axi4_sub_if[top_pkg::RomCtrlMem].arvalid  = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar_valid;
  axi4_sub_if[top_pkg::RomCtrlMem].arid     = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.id;
  axi4_sub_if[top_pkg::RomCtrlMem].araddr   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.addr;
  axi4_sub_if[top_pkg::RomCtrlMem].arlen    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.len;
  axi4_sub_if[top_pkg::RomCtrlMem].arsize   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.size;
  axi4_sub_if[top_pkg::RomCtrlMem].arburst  = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.burst;
  axi4_sub_if[top_pkg::RomCtrlMem].arlock   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.lock;
  axi4_sub_if[top_pkg::RomCtrlMem].arcache  = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.cache;
  axi4_sub_if[top_pkg::RomCtrlMem].arprot   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.prot;
  axi4_sub_if[top_pkg::RomCtrlMem].arqos    = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.qos;
  axi4_sub_if[top_pkg::RomCtrlMem].arregion = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.region;
  axi4_sub_if[top_pkg::RomCtrlMem].aruser   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].ar.user;

  axi4_sub_if[top_pkg::RomCtrlMem].bready   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].b_ready;
  axi4_sub_if[top_pkg::RomCtrlMem].rready   = `AXI_XBAR_HIER.mst_ports_req_o[top_pkg::RomCtrlMem].r_ready;

  // Response signals (Subordinate -> XBAR)
  axi4_sub_if[top_pkg::RomCtrlMem].awready  = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].aw_ready;
  axi4_sub_if[top_pkg::RomCtrlMem].wready   = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].w_ready;
  axi4_sub_if[top_pkg::RomCtrlMem].arready  = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].ar_ready;

  axi4_sub_if[top_pkg::RomCtrlMem].bvalid   = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].b_valid;
  axi4_sub_if[top_pkg::RomCtrlMem].bid      = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].b.id;
  axi4_sub_if[top_pkg::RomCtrlMem].bresp    = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].b.resp;
  axi4_sub_if[top_pkg::RomCtrlMem].buser    = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].b.user;

  axi4_sub_if[top_pkg::RomCtrlMem].rvalid   = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].r_valid;
  axi4_sub_if[top_pkg::RomCtrlMem].rid      = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].r.id;
  axi4_sub_if[top_pkg::RomCtrlMem].rdata    = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].r.data;
  axi4_sub_if[top_pkg::RomCtrlMem].rresp    = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].r.resp;
  axi4_sub_if[top_pkg::RomCtrlMem].rlast    = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].r.last;
  axi4_sub_if[top_pkg::RomCtrlMem].ruser    = `AXI_XBAR_HIER.mst_ports_resp_i[top_pkg::RomCtrlMem].r.user;
end

// SRAM - Tapping the XBAR Manager Port 1 (Subordinate VIP side)
...
// Mailbox - Tapping the XBAR Manager Port 2 (Subordinate VIP side)
...
// TLcrossbar - Tapping the XBAR Manager Port 3 (Subordinate VIP side)
...
// DRAM - Tapping the XBAR Manager Port 4 (Subordinate VIP side)
