...
module tb;
  ...
  tl_if tl_if (
    .clk,
    .rst_n(rstmgr_if.resets_o.rst_io_n[rstmgr_pkg::Domain0Sel])
  );
  ...
  rstmgr dut (
    .clk_i        (clk),
    .rst_ni       (rstmgr_if.resets_o.rst_io_n[rstmgr_pkg::Domain0Sel]),
    .clk_aon_i    (clk_aon),
    .clk_io_i     (clk_io),
    .clk_main_i   (clk_main),
    .clk_por_i    (clk_io),
  ...
  initial begin
    ...
    force clk_rst_if.rst_n = rstmgr_if.resets_o.rst_io_n[rstmgr_pkg::Domain0Sel];
  end
