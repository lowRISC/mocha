...
`ifndef __AXI4_VIP_SLAVE_AGENT_SVH
`define __AXI4_VIP_SLAVE_AGENT_SVH

class axi4_vip_slave_agent extends uvm_agent;

  `uvm_component_utils(axi4_vip_slave_agent)
...
endclass : axi4_vip_slave_agent

//------------------------------------------------------------------------------
// External Method Implementations
//------------------------------------------------------------------------------

function axi4_vip_slave_agent::new(string name, uvm_component parent);
  super.new(name, parent);
endfunction : new

function void axi4_vip_slave_agent::build_phase(uvm_phase phase);
...
`endif // __AXI4_VIP_SLAVE_AGENT_SVH