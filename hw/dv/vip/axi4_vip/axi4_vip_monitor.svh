...
task axi4_vip_monitor::collect_aw_channel();
  ...
  bit [`AXI4_MAX_ID_WIDTH-1:0]     id_mask     = (`AXI4_MAX_ID_WIDTH'(1)     << m_cfg.m_id_width)     - 1;
  bit [`AXI4_MAX_ADDR_WIDTH-1:0]   addr_mask   = (`AXI4_MAX_ADDR_WIDTH'(1)   << m_cfg.m_addr_width)   - 1;
  bit [`AXI4_MAX_USER_WIDTH-1:0]   user_mask   = (`AXI4_MAX_USER_WIDTH'(1)   << m_cfg.m_user_width)   - 1;
  bit [`AXI4_MAX_REGION_WIDTH-1:0] region_mask = (`AXI4_MAX_REGION_WIDTH'(1) << m_cfg.m_region_width) - 1;
  bit [`AXI4_MAX_QOS_WIDTH-1:0]    qos_mask    = (`AXI4_MAX_QOS_WIDTH'(1)    << m_cfg.m_qos_width)    - 1;
