...
// driven verbatim as supplied, except that WLAST is asserted when driving the final item.
//
...
class axi_mgr_write_listed_data_seq extends axi_mgr_write_data_seq;
  ...
  // Override axi_mgr_write_data_seq::populate_item to "produce" each beat by copying the next
