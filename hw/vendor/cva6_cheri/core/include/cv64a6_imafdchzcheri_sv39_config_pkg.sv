...
package cva6_config_pkg;
  ...
  localparam config_pkg::cva6_user_cfg_t cva6_cfg = '{
      ...
      BHTHist: unsigned'(3),
      DmBaseAddress: top_bus_pkg::DebugMemBase,
      ...
      ExecuteRegionAddrBase: 1024'({top_bus_pkg::DRAMBase, top_bus_pkg::SRAMBase, top_bus_pkg::DebugMemBase, top_bus_pkg::RomCtrlMemBase}),
      ExecuteRegionLength: 1024'({top_bus_pkg::DRAMUsableLength, top_bus_pkg::SRAMLength, top_bus_pkg::DebugMemLength, top_bus_pkg::RomCtrlMemLength}),
      NrCachedRegionRules: unsigned'(1),
      CachedRegionAddrBase: 1024'({top_bus_pkg::DRAMBase}),
      CachedRegionLength: 1024'({top_bus_pkg::DRAMUsableLength}),
