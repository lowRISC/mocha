...
static bool spi_boot_strap(struct context *ctx);
...
static void led_animation_run(struct context *ctx);
static bool bootstrap_requested(struct context *ctx);


// TODO: Add support to cheri mode
int main(void)
{
    struct context boot_ctx = (struct context){
...
bool spi_boot_strap(struct context *ctx)
{
    led_init(ctx->gpio);
...
void led_animation_run(struct context *ctx)
{
...
bool bootstrap_requested(struct context *ctx)
{
